...
export const servicesCardItems = [
    ...
    },
    {
        ...
        description:
            'Architecture planning and design is a high-impact exercise. Polymath Labs partners with technology teams to develop architecture that can deliver on AWS’ potential.',

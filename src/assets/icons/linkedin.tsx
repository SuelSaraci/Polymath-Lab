...
const LinkedInIcon = ({ fillColor }: { fillColor: string }) => (
    <svg height='512px' width='512px' viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'>
        <g id='_x35_6-linkedin'>
          ...
          c0,0,80.643-112.628,114.674-29.911V495.25h106.688V273.257C494.604,223.549,460.629,182.13,414.789,170.138L414.789,170.138z
          M414.789,170.138'
                    style={{ fill: fillColor }}
                />
                <path
                    d='M121.789,69.085c0,28.909-23.373,52.337-52.195,52.337c-28.824,0-52.196-23.429-52.196-52.337
          c0-28.903,23.372-52.335,52.196-52.335C98.416,16.75,121.789,40.182,121.789,69.085L121.789,69.085z M121.789,69.085'
                    style={{ fill: fillColor }}
                />
            </g>
        </g>

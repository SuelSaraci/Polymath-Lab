...
const MaturateIcon = ({ fillColor = '#010002' }: { fillColor: string }) => (
    <svg
        height='800px'
        width='800px'
        version='1.1'
        ...
        <g>
            <g>
                <path
                    ...
                    d='M261.73,151.48l52.374-0.69c6.881-0.086,15.876,4.487,19.888,10.16l30.221,42.753
            ...
            C252.498,147.08,254.827,151.523,261.73,151.48z'
                ...
                <path
                    style={{ fill: fillColor }}
                    d='M498.793,432.202l0.863-0.884L75.811,7.56l-0.475,0.453c-0.065-0.022-0.065-0.086-0.129-0.108
